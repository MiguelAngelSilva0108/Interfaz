...
public class Proceso extends JFrame {
    ...
    public Proceso(String usuario, String contrasena, Bd bd) {
    ...
    // instancia
    public void setUsuarioYContrasena(String usuario, String contrasena) {
        this.usuario = usuario;
        this.contrasena = contrasena;
    }
    ...
    public void mostrarVentana() {
        ...
        // Crear un panel superior para el mensaje de bienvenida y botón de cerrar sesión
        ...
        queryButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Querys querysWindow = new Querys(usuario, contrasena, bd);
